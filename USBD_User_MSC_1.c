...
// Called during USBD_Initialize to initialize the USB Device MSC class instance 1.
...
// \brief Called during \ref USBD_Uninitialize to de-initialize the USB Device MSC class instance 1.
